...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('bupots', function (Blueprint $table) {
            ...
            $table->decimal('bruto_2_tahun', 17, 0)->nullable();
            ...
            $table->decimal('pajak_penghasilan', 17, 0)->nullable();
            $table->decimal('gaji_pokok_pensiun', 17, 0)->nullable();
            $table->decimal('pembulatan_kotor', 17, 0)->nullable();
            $table->decimal('tunjangan_pph', 17, 0)->nullable();
            $table->decimal('tunjangan_lainnya', 17, 0)->nullable();
            $table->decimal('honorarium_imbalan_lainnya', 17, 0)->nullable();
            $table->decimal('premi_asuransi_pemberi_kerja', 17, 0)->nullable();
            $table->decimal('natura_pph_pasal_21', 17, 0)->nullable();
            $table->decimal('tantiem_bonus_gratifikasi_jasa_thr', 17, 0)->nullable();
            $table->decimal('biaya_jabatan', 17, 0)->nullable();
            $table->decimal('iuran_pensiun', 17, 0)->nullable();
            $table->decimal('sumbangan_keagamaan_pemberi_kerja', 17, 0)->nullable();
            $table->decimal('jumlah_pengurangan', 17, 0)->nullable();
            $table->decimal('jumlah_penghasilan_neto', 17, 0)->nullable();
            $table->decimal('nomor_bpa1_sebelumnya', 17, 0)->nullable();
            $table->decimal('penghasilan_neto_sebelumnya', 17, 0)->nullable();
            $table->decimal('penghasilan_neto_pph_pasal_21', 17, 0)->nullable();
            $table->decimal('penghasilan_tidak_kena_pajak', 17, 0)->nullable();
            $table->decimal('penghasilan_kena_pajak', 17, 0)->nullable();
            $table->decimal('pph_pasal_21_ditanggung_pemerintah', 17, 0)->nullable();
            $table->decimal('pph_pasal_21_masa_pajak_terakhir', 17, 0)->nullable();
            $table->decimal('pph_pasal_21_penghasilan_kena_pajak', 17, 0)->nullable();
            $table->decimal('pph_pasal_21_terutang', 17, 0)->nullable();
            $table->decimal('pph_pasal_21_potongan_bpa1_sebelumnya', 17, 0)->nullable();
            $table->decimal('pph_pasal_21_terutang_bupot_ini', 17, 0)->nullable();
